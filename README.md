...
```
$tangent(radian) = \frac{  \sum_{current=0}^{maximum}{-1 ^ i \times \frac{radian ^ \left(2\times c\right)}{(2 \times current) !}} }{\sum_{current=0}^{maximum}{-1 ^ i \times \frac{radian ^ \left(2\times c+1\right)}{(2 \times current+1) !}}}$
```
